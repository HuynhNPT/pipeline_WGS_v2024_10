        ...
        final cond = new Predicate<? extends Throwable>() {
            ...
            boolean test(Throwable t) {
                if( t instanceof UnavailableException )
                    return true
                if( t instanceof InternalException || t.cause instanceof InternalException )
                    return true
                if( t instanceof DeadlineExceededException || t.cause instanceof DeadlineExceededException )
                    return true
